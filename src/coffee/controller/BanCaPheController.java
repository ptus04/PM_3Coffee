...
public class BanCaPheController implements ActionListener {
	...
	private static BanCaPheController instance;

	public static BanCaPheController getInstance() throws SQLException {
		if (instance == null)
			instance = new BanCaPheController();
		return instance;
	}

	public BanCaPheController() throws SQLException {
//		this.gui = gui;
		gui = new BanCaPheView();
//		gui.setVisible(true);
...
//		} else
	...
	private void XuLyThanhToanHoaDonController() {
		...
		try {
			...
			donHang = new DonHang(maDonHang, khachTra, thue, thoiGianTao, thoiGianIn, ghiChu, phuongThucThanhToan,
