...
public class MenuCaPheController {
	...
	private static MenuCaPheController instance;

	public static MenuCaPheController getInstance() {
		if (instance == null)
			instance = new MenuCaPheController();
		return instance;
	...
	public MenuCaPheView getView() {
		return view;
	}

	public MenuCaPheController() {
		this.view = new MenuCaPheView();
	}
	...
	public void themSanPham(String sanPhamDuocChon) {
		if (sanPhamDuocChon != null) {
			try (Connection conn = Database.getInstance().getConnection()) {
				...
				e.printStackTrace();
				JOptionPane.showMessageDialog(view, "Lỗi khi thêm món vào cơ sở dữ liệu.", "Lỗi",
						JOptionPane.ERROR_MESSAGE);
			}
		} else {
			JOptionPane.showMessageDialog(view, "Vui lòng chọn món trước khi thêm.", "Thông báo",
					JOptionPane.INFORMATION_MESSAGE);
		}
	}

	// Method to handle editing product (could be expanded to actually update
	// product details)
	public void suaSanPham(String sanPhamDuocChon) {
		if (sanPhamDuocChon != null) {
			...
			JOptionPane.showMessageDialog(view, "Vui lòng chọn món trước khi sửa.", "Thông báo",
					JOptionPane.INFORMATION_MESSAGE);
		}
	}
}
