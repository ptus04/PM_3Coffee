...
public class NhanVien {
    ...
    public void setHeSoLuong(float heSoLuong) {
        if (heSoLuong >= 1.0) {
            ...
            throw new IllegalArgumentException("Hệ số lương phải lớn hơn hoặc bằng 1.0.");
        }
    }
    ...
    public NhanVien(String maNhanVien, String hoTen, boolean gioiTinh, LocalDate ngaySinh, String soCanCuoc,
                    String soDienThoai, String diaChi, float heSoLuong, boolean laQuanLy, String hinhAnh,
                    TaiKhoan taiKhoan, TrangThaiLamViec trangThaiLamViec) {
